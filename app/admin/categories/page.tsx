...
import AdminCategoriesListClient from "@/components/AdminCategoriesListClient";
...
export const metadata: Metadata = {
  ...
  description: "Create and manage tool categories.",
};
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">Manage tool categories and their metadata.</p>
            </div>
            <Link
